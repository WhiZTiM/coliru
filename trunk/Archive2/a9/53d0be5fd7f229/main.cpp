...
int main() {
    ...
    bool iso = vf2_graph_iso(graph_small, graph_large, my_callback<Graph, Graph>(graph_small, graph_large), vos,
    ...
    std::cout << "equal(graph_small, graph_large,my_callback)=" << std::boolalpha << iso << std::endl;
}
