...
struct add_to_tag_to_iterator_map:
  boost::mpl::fold<
...
struct tag_to_iterator_map:
  boost::mpl::fold<
    typename MultiIndexContainer::index_type_list,
    boost::mpl::map<>,
    add_to_tag_to_iterator_map<boost::mpl::_1,boost::mpl::_2>
  >
{};
...
struct tag_from_iterator:
  boost::mpl::at<
    typename tag_to_iterator_map<MultiIndexContainer>::type,
    Iterator
  >
{};
