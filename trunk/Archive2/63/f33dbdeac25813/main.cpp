...
#define EXPAND_BODY(r, data, i, elem) BOOST_PP_COMMA_IF(i) elem
...
BOOST_ASIO_CORO_YIELD then(future, [self = std::move(*this)](auto ready_future) mutable \
{ \
