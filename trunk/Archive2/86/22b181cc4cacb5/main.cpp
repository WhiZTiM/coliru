...
struct BBPort : Tx::HigherLayer
{
    ...
    void sendPackets(Stack::Internal, const std::vector<Stack::Packet>& packets)
    {
        ...
        // This method needs to be is async (non-blocking). No packet data copy happens here.
        // We simply append the (ref-counted) packet objects to the lockfree queue and we are done.
        // This allows the protocolstack to quickly resume its work without wasting time here.
