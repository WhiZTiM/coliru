...
int main(int argc, char* argv[])
{
    ...
    std::vector<std::pair<std::unique_ptr<Restaurant>, dynarray<Pizza>>> pairs;
    pairs.emplace_back(std::make_pair(std::unique_ptr<Restaurant>(new Restaurant()), dynarray<Pizza>(64)));
