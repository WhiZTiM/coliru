...
struct parser_t
{
    static  decltype(::boost::spirit::qi::auto_) parser = ::boost::spirit::qi::auto_;
};

template <>
struct parser_t< bool >
{
    static  decltype(::boost::spirit::qi::auto_ | (::boost::spirit::qi::lit("0") | ::boost::spirit::qi::lit("1"))) parser;
        //= ::boost::spirit::qi::auto_ | (::boost::spirit::qi::lit("0") | ::boost::spirit::qi::lit("1"));
};
*/

//template<typename T>
//const decltype(::boost::spirit::qi::auto_) parser_t::parser = ::boost::spirit::qi::auto_;

/*
template< typename T, T N >
struct parser_t<T, std::integral_constant<T, N>>
{
    static constexpr auto parser = ::boost::spirit::qi::auto_;
};
*/

/*
template< bool, bool N >
struct parser_t<bool, typename U = std::integral_constant<bool, N>>
{
    static constexpr auto parser = ::boost::spirit::qi::auto_
    | (::boost::spirit::qi::lit("0")[boost::phoenix::ref(U::value) = 0] 
            | ::boost::spirit::qi::lit("1")[boost::phoenix::ref(U::value) = 1] );
};*/
...
//    auto parser = auto_ | ( lit("0")[ref(value) = 0] | lit("1")[ref(value) = 1] );
    auto parser = auto_ | ( lit("0")[ref(value) = 0] | lit("1")[ref(value) = 1] );
    
    //if (!parse(f, l, parser ) || f != l) {
    if (!parse(f, l, parser, value ) || f != l) {
        throw std::string("bad boy");
    }
...
/*template <typename T>
struct strict_real_policies_dot : ::boost::spirit::qi::real_policies<T>
{
...
T tutu(std::string const& str) {
    ...
    ::boost::spirit::qi::real_parser<T, ::boost::spirit::qi::real_policies<T> > parser;
    ...
    auto f2(str.cbegin());
    auto l2(str.cend());  
    if(! parse(f, l, parser | int_parser, value)
         || f != l ) {
