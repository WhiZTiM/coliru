...
double maxx(double(*f)(double), double &a, double &b, const double tol = 1e-5);
double f(double x); // finds expected payoff function 
...
double maxx(double(*f)(double), double &a, double &b, const double tol)
{
