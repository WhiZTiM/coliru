...
template<typename SK,typename T>
uint volatile Component<SK,T>::index(ComponentCount<SK>::template next<T>());
...
int main()
{
    // function scope
    struct Z{};
//    using zi = Component<Z,int>;
//    using zd = Component<Z,double>;
//    using zs = Component<Z,std::string>;
