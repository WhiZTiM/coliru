...
int main()
{
    ...
    an_observer observer(subject) ; // handle event in a private member function
    
    // handlwe event in a closure
    ...
    // handle event in a function at namespace scope
    ...
    // handle event using a function object
