...
template<class X>using block_deduction=type_t<tag<X>>;
    ...
    public:
        ...
        void transform(block_deduction<std::function<void(Components...)>> fn) {
            for (auto& e : entities) {
