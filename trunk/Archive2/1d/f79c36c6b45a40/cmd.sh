##clang++ --version
##g++-4.9 --version
##g++-4.9 -std=c++11 -fsanitize=undefined -D_GLIBCXX_DEBUG -Wall -Wextra -pedantic main.cpp && ./a.out
##g++-4.9 -std=c++11  -fdump-tree-optimized  -Wall -Wextra -Wconversion  -pedantic-errors  -O2 -pthread  main.cpp && ./a.out && cat main.cpp.169t.optimized
##g++ --version
...
set -x ; gcc -x c -std=c99 -Wconversion main.cpp   && ./a.out
##set -x ; gcc -x c -O2  -fno-aggressive-loop-optimizations -std=c99 -Wall -Wextra -Wconversion -pedantic main.cpp -l c  && ./a.out
