...
typename std::common_type<First, Second, Rest...>::type
MinMax(Func&& f, First&& first, Second&& second, Rest&& ...args)
{
...
{
   int minimum = MinMax([] (auto x, auto y) { return x < y ? x : y; }, 1.5, 2, 3, 4); 
