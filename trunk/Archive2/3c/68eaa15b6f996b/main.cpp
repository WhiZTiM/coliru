...
template <typename Graph1, typename Graph2>
bool my_bundled_subgraph_iso(Graph1 const& small, Graph2 const& large) {
...
int main() {
    ...
    std::cout << " my_bundled_subgraph_iso(dataG.at(0), dataG.at(1))=" << std::boolalpha << my_bundled_subgraph_iso(dataG.at(0), dataG.at(1)) << std::endl;
