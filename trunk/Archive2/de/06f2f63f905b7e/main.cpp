...
int main() {
    typedef Input<1> x; x::name = "x";
    typedef Input<2> x_mark; x_mark::name = "x_mark";
    typedef Input<3> split; split::name = "split";
    typedef State<0> start; start::name = "start";
    typedef State<1> find_blank; find_blank::name = "find_blank";
    typedef State<2> go_back; go_back::name = "go_back";
