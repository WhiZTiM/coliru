//
// tag types to select cv qualifier and reference qualifier
//
...
template <typename... Ts>
struct underload<cv_none, Ts...>
    : underload<cv_none, ref_none, Ts...>
...
template <typename... Ts>
struct underload<cv_volatile, Ts...>
...
#define UNDERLOAD(CV_TAG, REF_TAG)              \
    template <typename... Ts>                   \
    struct underload<REF_TAG, CV_TAG, Ts...>    \
        : underload<CV_TAG, REF_TAG, Ts...> {};
UNDERLOAD(cv_none,     ref_none)
