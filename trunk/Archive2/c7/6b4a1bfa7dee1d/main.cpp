...
int main()
{
    DALI::Standard::Target *target = new DALI::Standard::Target(DALI::Standard::TargetType::BROADCAST, 1); //Pobably look at making target on stack
    DALI::Standard::Command command = DALI::Standard::Command( target, DALI::Standard::CMD_ON ); //This will accept any DALICommand type, weak protection can be added by doing similar thing that target does.
