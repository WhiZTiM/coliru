...
class GenericBase : public Generic<GenericBase>
{
};
...
int main () {
    {
        std::cout << "Specific class" << std::endl;
        Specific s;
        s << 5 << std::vector<int>({1, 2, 3}) << Dummy(666) << DummyArray({Dummy(123)});
    }
    {
        std::cout << "Generic class" << std::endl;
        GenericBase g;
        g << 5 << std::vector<int>({1, 2, 3});
    }
