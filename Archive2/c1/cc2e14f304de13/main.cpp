...
any /* <--- erased type */ pred = [](auto n)
{
    return [n=move(n)](auto f)
    {
        return [=, f=move(f)](auto x)
        {
            auto gf = [=](auto g)
            {
                return [=, g=move(g)](const auto &h)
                {
                    return h(g(f));
                };
            };
            auto ux = [=](auto) { return x; };
...
int main()
{
    auto result = 0;
    {
        ...
        any /* <--- erased type */ num10 = n<10>(),
                                   num4  = n<4>();
        result = pred(power(num10)(num4))(inc)(0);
    }
    cout << result << endl;
}
