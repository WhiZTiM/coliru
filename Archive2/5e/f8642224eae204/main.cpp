...
// This file can be also found using the Coliru command line: cat /Archive2/f0/f219473c8159e2/main.cpp
...
int main()
{
    SpaceShip *p_apollo = new ApolloSpacecraft();
    SpaceShip *p_enterprise = new StarTrekEnterprise();
    SpaceShip *p_deathstar = new DeathStar();
