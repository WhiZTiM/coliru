...
BOOST_FUSION_ADAPT_STRUCT(mine::int_1,  i1    )
BOOST_FUSION_ADAPT_STRUCT(mine::int_2a, i1, i2)
BOOST_FUSION_ADAPT_STRUCT(mine::int_2b, i1, i2)
BOOST_FUSION_ADAPT_STRUCT(mine::data, type, value)
