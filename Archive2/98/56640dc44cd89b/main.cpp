...
AtomosPrinter CrearPrinter(Atomos const& atomos)
{
    AtomosPrinter printer(atomos);
...
AtomosPrinter InicializarAtomosYCrearPrinter(Atomos&& a)
{
    ...
    return CrearPrinter(a);
}

int main()
{
    // Esta construcción imprime:
    //   Copiando...
    //   Moviendo...
    //   Moviendo...
    //   Moviendo...
    
    // (A) Identifica y explica donde se están produciendo
    // éstas copias y movientos.
    //
    // (B) Modifica las funciones y clases pertinentes para que
    // la salida sea:
    //   Moviendo...
    //   Moviendo...
    //   Moviendo...
    //   Moviendo...
    // y explica el razonamiento seguido para conseguirlo. 
