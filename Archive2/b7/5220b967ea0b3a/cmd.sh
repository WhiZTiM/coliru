##clang++ --version
##g++-4.9 --version
g++-4.9  -Wall -Wextra -pedantic main.cpp && ./a.out
...
##set -x ; clang++  -Doverride= -D_GLIBCXX_DEBUG -stdlib=libstdc++ -std=c++11 -fsanitize=undefined -Wall -Wextra -Wconversion  -pedantic main.cpp && ./a.out 
...
##set -x ; clang -x c -std=c89 -fsanitize=undefined   -Wall -Wextra -Wconversion -O3  -pedantic main.cpp && ./a.out