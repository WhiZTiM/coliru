...
vx_image outputImage = vxCreateImage(context, width, height, VX_DF_IMAGE_RGBX);
...
//
// Release data objects which are not needed to be referenced anymore
//
...
//
// Release nodes which are not needed to be referenced anymore
//
