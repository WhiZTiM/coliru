...
class sdk_client
{
    ...
    struct callee_base
    {
        ...
        virtual void operator() (CbAuthen const& cb)  = 0;
    };
    ...
    struct callee: callee_base
    {
        ...
        void operator() (CbAuthen const& cb)  { user_ (cb); }
...
public:
    ...
    void call_smth ()
    {
        ...
        std::cout << "sdk_client::call_smth: calling user callback (CbAuthen)\n";
        (*cb_) (CbAuthen ()); // as auth callback is not defined, base callback should be called.
        std::cout << std::endl;
    }
