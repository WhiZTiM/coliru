...
typename boost::disable_if<is_some_kind_of_Base<T1>, make_mult_operation<Terminal<T1>, T2, T1, R2> >::type::type
...
typename boost::disable_if<is_some_kind_of_Base<T2>, make_mult_operation<T1, Terminal<T2>, R1, T2> >::type::type
