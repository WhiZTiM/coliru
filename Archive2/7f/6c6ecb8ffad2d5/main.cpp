...
int main()
{
    ...
    //auto&& x = merge_tuple(std::tuple<std::tuple<std::tuple<std::tuple<Noisy, Noisy>>>, std::tuple<std::tuple<Noisy>>>());
    /*test(
        merge_tuple(std::tuple<std::tuple<std::tuple<std::tuple<Noisy, Noisy>>>, std::tuple<std::tuple<Noisy>>>())
        );*/
    std::cout << "--------------------------" << std::endl;
